# Generated by Django 4.2.5 on 2023-11-02 06:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('products', '0037_remove_product_shop_created_date_1_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.order')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.product_shop')),
            ],
        ),
    ]
